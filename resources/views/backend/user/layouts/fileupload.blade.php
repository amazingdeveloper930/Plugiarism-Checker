...
<div class="card">
    ...
    <div class="row justify-content-center ml-auto" id = "upload-content">
        <div class="row" style="display: block; width: 100%; margin: 0px auto; text-align: center;"><h3>Press the upload button to process file.</h3></div>
        <br/>
        <input id = "demo_version" hidden type = "text" value = '{{ Session::has('demo_user')? "Yes" : "No" }}'/>
    ...
    <div class="row justify-content-center" id = "file-process-container" style="display: none">
        <div class="row table-responsive" id = "file-list-container">
            <table class="table table-striped table-hover">
                ...
                <tbody id = "file-list">
                    ...
                    <tr id = "{{'file-'.$uploaded_file['id']}}">
                        ...
                        <td class="td-actions">
                                @if ($uploaded_file['status'] == 0)
                                    <button  class="btn btn-success  btn-round" onclick="processFile({{$uploaded_file['id']}})" rel="tooltip"  data-original-title="Process File" title="Process File"><i class="material-icons">play_arrow</i></button>
                                    <button  onclick="deleteFile({{$uploaded_file['id']}})" class="btn btn-danger btn-round" title="Delete File"><i class="material-icons">close</i></button>
                                @elseif ($uploaded_file['status'] == 1)
                                    <button  class="btn btn-success  btn-round" disabled><i class="material-icons">play_arrow</i></button>
                                    <button  disabled class="btn btn-danger btn-round" title="Delete Report"><i class="material-icons">close</i></button>
                                @elseif ($uploaded_file['status'] == 2)
                                    <button  class="btn btn-info  btn-round" rel="tooltip" data-original-title="View Report" title="View Report"><i class="material-icons">remove_red_eye</i></button>
                                    <button  onclick="deleteFile({{$uploaded_file['id']}})" class="btn btn-danger btn-round" title="Delete File"><i class="material-icons">close</i></button>
                                @endif
                        </td>
                    </tr>
...
<script type="text/javascript">
        ...
        $("#upload-button").click(function(){
          ...
          var demo_version = $("#demo_version").val();
          if(demo_version == "Yes")
          {
