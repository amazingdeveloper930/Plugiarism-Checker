<style type="text/css">
    ...
    <div class="row justify-content-center ml-auto" id = "upload-content">
      <div  style="display: block; width: 100%; margin: 0px auto; text-align: center; padding: 20px;
    color: white;"><h3>Press the upload button to process file.</h3></div>
        <br/>
        ...
        <div  style="display: block; width: 100%; margin: 0px auto; text-align: center; padding: 20px;
    color: white;"><h3>For individuals</h3>
    <p>Upload your paper and start check for plagiarism. Our software will scan it and detect plagiarism. Your paper will not be stored to database and will not make you troubles if you check it again here or anywhere else. Service is prepaid, which means you pay in advance</p></div>
